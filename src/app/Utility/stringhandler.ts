export class StringHandler {
    ...
    //Titles
    static readonly cardTitleOne: string = 'Notify';
    static readonly cardTitleTwo: string = 'SWAPI-API';
    static readonly cardTitleThree: string = 'WeatherApp';
    static readonly cardTitleFour: string = 'Portfolio';
    static readonly cardTitleFive: string = 'Falling-Rocks';
    ...
    static readonly CardLinkTwo: string = "https://github.com/Carpenteri1/SWAPI-Web-Scrapper";
    static readonly CardLinkThree: string = "https://github.com/Carpenteri1/WeatherApp";
    static readonly CardLinkFour: string = "https://github.com/Carpenteri1/Portfolio";
    static readonly CardLinkFive: string = "https://github.com/Carpenteri1/Falling-Rocks";
    static readonly CardLinkSix: string = "https://github.com/Carpenteri1/KrankenHause";
